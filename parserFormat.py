...
class reportParserFormat:
    ...
    def __post_init__(self):
        ...
        self.consolidatedNetIncome = [r'연\s*결\s포\s*괄\s*손\s*익\s*계\s*산\s*서\s*', r'.*손\s*익\s*계\s*산\s*서\s*']
        ...
        self.nonConsolidatedNetIncome : list() = [r'^[^가-힣]*포\s*괄\s*손\s*익\s*계\s*산\s*서\s*', r'^[가나다라마바사아]*[^가-힣]*포\s*괄\s*손\s*익\s*계\s*산\s*서\s*']
